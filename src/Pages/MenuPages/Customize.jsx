    ...
    return (
        <>
            ...
            <nav className="sub-menu-navigation">
                <p><Link to="/menu">Menu</Link>/ <Link to={`/${item_sub_cat}`}>{item_sub_cat}</Link >/ <Link>{item_name}</Link ></p>
            </nav>
            <div>
                                ...
                                <div className="info-option">
                                    ...
                                    <div className="flex-selection">
                                        <fieldset>
                                            ...
                                            <div>
                                                <button onClick={handleSweetDecr} className="flex-sub">-</button>
                                                <span>{sweetener}</span>
                                                <button onClick={handleSweetIncr} className="flex-add">+</button>
                                            </div>
                                        </fieldset>
                                    </div>
